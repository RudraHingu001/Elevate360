<?php include 'components/header.php'; ?>
      <div class="home3-banner-area">
         <svg class="vector" xmlns="http://www.w3.org/2000/svg" width="336" height="418" viewBox="0 0 336 418" fill="none">
                  ...
                  <div class="banner-right">
                     <div class="banner-right-content">
                        <p>Marketing agencies play a crucial role in <span>promoting products, services, or
                           brands</span> to target audiences.
                        </p>
                     </div>
                  </div>
               </div>
      ...
      <div class="text-slider-section three mb-130">
         <div class="marquee">
      ...
      <div class="home3-about-section mb-130">
         <div class="container-lg container-fluid">
            <div class="row">
               ...
               <div class="col-lg-8">
                  <div class="section-title five mb-70 text-animation">
      ...
      <div class="home3-working-process-section mb-130">
         <div class="container-lg container-fluid">
            <div class="row mb-50">
               <div class="col-lg-4">
                  <div class="sub-title2 text-animation">
