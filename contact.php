               ...
               <div class="row gy-5 justify-content-between">
                           ...
                           <div class="single-location mb--30">
                              ...
                              <ul>
                                 <li>
                                    ...
                                    <div class="info">
                                       <a href="tel:+91-8866519805">+91-8866519805</a>
                                    </div>
                                 </li>
                                 <li>
                                    <div class="icon">
                                    ...
                                    <div class="info">
                                       <a href="mailto:rudrahingu001@gmail.com">rudrahingu001@gmail.com</a>
                                    </div>
                                 </li>
                                 <li>
                                    <div class="icon">
                           ...
                           <div class="single-location">
                              ...
                              <ul>
                                 <li>
                                    ...
                                    <div class="info">
                                       <a href="tel:+91-9662968183">+91 9662968183</a>
                                    </div>
                                 </li>
                                 <li>
                                    <div class="icon">
                                    ...
                                    <div class="info">
                                       <a href="mailto:mihirgoswami2006@gmail.com">mihirgoswami2006@gmail.com</span></a>
                                    </div>
                                 </li>
                                 <li>
                                    <div class="icon">
                  ...
                  <div class="col-xl-8">
                     <div class="contact-form-wrap">
                        <form method="post" action="https://formspree.io/f/xknljorv">
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-inner mb-30">
                                    <label>Full Name*</label>
                                    <input type="text" name="name" placeholder="Daniel Scoot">
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-inner mb-30">
                              ...
                              <div class="col-md-6">
                                 <div class="form-inner mb-30">
                                    ...
                                    <input type="text" name="phone" placeholder="+91- 5566 **** ****">
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-inner mb-30">
