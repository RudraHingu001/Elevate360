               ...
               <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                           <div class="footer-logo-contact-wrap">
                              <div class="footer-logo">
                                 <a href="index.php"><img src="assets/img/logo.jpeg" width="100px" alt="footer-logo"></a>
                              </div>
                              <ul class="footer-contact">
                                 <li class="single-contact">
                                    <span>Phone</span>
                                    <h5><a href="tel:+91-8866519805">+91 8866519805</a></h5>
                                 </li>
                                 <li class="single-contact">
                                    <span>Email Now</span>
                                    <h5><a href="mailto:rudrahingu001@gmail.com">rudrahingu001@gmail.com</a>
                                    </h5>
                                 </li>
                              </ul>
                           </div>
                  ...
                  <div class="footer-btm">
                     <div class="copyright-area">
                        <p>Copyright 2024 <a href="">Elevate360</a> | Design By <a href="">Elevate360</a></p>
                     </div>
                  </div>
               </div>
            </div>
