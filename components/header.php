...
<html lang="en">
   <head>
      ...
      <title>Elevate360 - Digital Agency Creative Portfolio Template</title>
      <link rel="icon" href="assets/img/logo.jpeg" type="image/gif" sizes="20x20">
   </head>
   <body id="body" class="tt-smooth-scroll tt-magic-cursor home1-bg dark">
      <div id="magic-cursor">
         <div id="ball"></div>
      </div>
      ...
      <div class="sidebar-area">
         <div class="sidebar-menu-top-area two">
            <div class="sidebar-menu-logo">
               <a class="logo-dark" href="index.php"><img alt="image" width="100px" class="img-fluid" src="assets/img/logo.jpeg"></a>
               <a class="logo-light" href="index.php"><img alt="image" width="100px" class="img-fluid" src="assets/img/logo.jpeg"></a>
            </div>
                     ...
                     <div class="getin-touch-area mb-60">
                        ...
                        <ul>
                           <li class="single-contact">
                              ...
                              <div class="contact">
                                 <span>Phone</span>
                                 <h6><a href="tel:+91-8866519805">+91 8866519805</a></h6>
                              </div>
                           </li>
                           <li class="single-contact">
                              <div class="icon">
                              ...
                              <div class="contact">
                                 <span>Email Now</span>
                                 <h6><a href="mailto:rudrahingu001@gmail.com">rudrahingu001@gmail.com</a>
                                 </h6>
                              </div>
                           </li>
                           <li class="single-contact">
      ...
      <header class="header-area style-1 two">
         <div class="header-logo">
            <a href="index.php"><img alt="image" class="img-fluid light" width="50px" src="assets/img/logo.jpeg"></a>
            <a href="index.php"><img alt="image" class="img-fluid dark" width="50px" src="assets/img/logo.jpeg"></a>
         </div>
         <div class="menu-wrap">
            <div class="main-menu">
               <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                  <div class="mobile-logo-wrap">
                     <a href="index.php"><img alt="image" width="100px" src="assets/img/logo.jpeg"></a>
                  </div>
               </div>
               <ul class="menu-list">
                  <li class="menu-item-has-children active">
                     <a href="index.php" class="drop-down">Home</a></i>
                  </li>
                  <li class="menu-item-has-children">
                     <a href="service.php" class="drop-down">Services</a></i>
                  </li>
                  <li class="menu-item-has-children">
                     <a href="about.php" class="drop-down">About</a></i>
                  </li>
                  <li class="menu-item-has-children">
                     <a href="pricing.php" class="drop-down">Pricing</a></i>
                  </li>
                  <li><a href="contact.php">Contact Us</a></li>
               </ul>
               <div class="d-lg-none d-block">
                  <ul class="topbar-right">
                     ...
                     <li>
                        <a href="/cdn-cgi/l/email-protection#bfd6d1d9d0decfd3d0c7d1ffd8d2ded6d391dcd0d2">
                           ...
                           <span class="__cf_email__" data-cfemail="bed7d0d8d1dfced2d1c6d0fed9d3dfd7d290ddd1d3">[email&#160;protected]</span>
                        </a>
                     </li>
                     <li>
